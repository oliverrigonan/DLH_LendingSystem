...
namespace Lending.Data
{
    ...
    partial void OnContactNumberChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstBranch_trnLoanApplication", Storage="_trnLoanApplications", ThisKey="Id", OtherKey="BranchId")]
		public EntitySet<trnLoanApplication> trnLoanApplications
		{
			get
			{
    ...
    partial void OnUpdatedDateTimeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstCollector_trnCollectionLine", Storage="_trnCollectionLines", ThisKey="Id", OtherKey="CollectedByCollectorId")]
		public EntitySet<trnCollectionLine> trnCollectionLines
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstCollector_trnLoanApplication", Storage="_trnLoanApplications", ThisKey="Id", OtherKey="CollectorId")]
		public EntitySet<trnLoanApplication> trnLoanApplications
		{
			get
			{
    ...
    partial void OnUpdatedDateTimeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstRequirement_trnLoanRequirement", Storage="_trnLoanRequirements", ThisKey="Id", OtherKey="RequirementId")]
    ...
    partial void OnUpdatedDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstUser_trnCollection3", Storage="_trnCollections3", ThisKey="Id", OtherKey="VerifiedByUserId")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstUser_trnDisbursement1", Storage="_trnDisbursements1", ThisKey="Id", OtherKey="VerifiedByUserId")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstUser_trnDisbursement2", Storage="_trnDisbursements2", ThisKey="Id", OtherKey="CreatedByUserId")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstUser_trnDisbursement3", Storage="_trnDisbursements3", ThisKey="Id", OtherKey="UpdatedByUserId")]
    ...
    partial void OnUpdatedDateTimeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstUser_trnCollection3", Storage="_mstUser3", ThisKey="VerifiedByUserId", OtherKey="Id", IsForeignKey=true)]
	...
	public partial class trnCollectionLine : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _CollectedByCollectorId;
    ...
    partial void OnCollectedByCollectorIdChanging(int value);
    partial void OnCollectedByCollectorIdChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CollectedByCollectorId", DbType="Int NOT NULL")]
		public int CollectedByCollectorId
		{
			get
			{
				return this._CollectedByCollectorId;
			}
			set
			{
				if ((this._CollectedByCollectorId != value))
				{
					if (this._mstCollector.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnCollectedByCollectorIdChanging(value);
					this.SendPropertyChanging();
					this._CollectedByCollectorId = value;
					this.SendPropertyChanged("CollectedByCollectorId");
					this.OnCollectedByCollectorIdChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstAccount_trnCollectionLine", Storage="_mstAccount", ThisKey="AccountId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstCollector_trnCollectionLine", Storage="_mstCollector", ThisKey="CollectedByCollectorId", OtherKey="Id", IsForeignKey=true)]
		public mstCollector mstCollector
		{
			...
			set
			{
							...
							|| (this._mstCollector.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.trnCollectionLines.Add(this);
						this._CollectedByCollectorId = value.Id;
					}
					else
					{
						this._CollectedByCollectorId = default(int);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="trnLoanApplication_trnCollectionLine", Storage="_trnLoanApplication", ThisKey="LoanId", OtherKey="Id", IsForeignKey=true)]
		public trnLoanApplication trnLoanApplication
		{
			get
			{
    ...
    partial void OnUpdatedDateTimeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstUser_trnDisbursement1", Storage="_mstUser1", ThisKey="VerifiedByUserId", OtherKey="Id", IsForeignKey=true)]
		public mstUser mstUser1
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstUser_trnDisbursement2", Storage="_mstUser2", ThisKey="CreatedByUserId", OtherKey="Id", IsForeignKey=true)]
		public mstUser mstUser2
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstUser_trnDisbursement3", Storage="_mstUser3", ThisKey="UpdatedByUserId", OtherKey="Id", IsForeignKey=true)]
		public mstUser mstUser3
		{
			get
			{
    ...
    partial void OnUpdatedDateTimeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstBranch_trnLoanApplication", Storage="_mstBranch", ThisKey="BranchId", OtherKey="Id", IsForeignKey=true)]
		public mstBranch mstBranch
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="mstCollector_trnLoanApplication", Storage="_mstCollector", ThisKey="CollectorId", OtherKey="Id", IsForeignKey=true)]
		public mstCollector mstCollector
		{
			get
			{
