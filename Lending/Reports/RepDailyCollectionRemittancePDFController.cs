        ...
        public ActionResult dailyCollectionRemittance(String startCollectionDate, String endCollectionDate)
        {
            if (startCollectionDate != null && endCollectionDate != null)
            {
                ...
                if (dailyCollectionRemittanceLists.Any())
                {
                    ...
                    collectionData.AddCell(new PdfPCell(new Phrase("Amount Remitted", fontArial12Bold)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f, BackgroundColor = BaseColor.LIGHT_GRAY });
                    collectionData.AddCell(new PdfPCell(new Phrase("Remarks", fontArial12Bold)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f, BackgroundColor = BaseColor.LIGHT_GRAY });
                    collectionData.AddCell(new PdfPCell(new Phrase("Signature", fontArial12Bold)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f, BackgroundColor = BaseColor.LIGHT_GRAY });
                    ...
                    foreach (var dailyCollectionRemittanceList in dailyCollectionRemittanceLists.OrderBy(d => d.Area))
                    {
                        ...
                        collectionData.AddCell(new PdfPCell(new Phrase(dailyCollectionRemittanceList.Area, fontArial11)) { PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f });
                        collectionData.AddCell(new PdfPCell(new Phrase(dailyCollectionRemittanceList.GrossCollection.ToString("#,##0.00"), fontArial11)) { HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f });
                        collectionData.AddCell(new PdfPCell(new Phrase(dailyCollectionRemittanceList.NetRemitted.ToString("#,##0.00"), fontArial11)) { HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f });
                        ...
                        if (dailyCollectionRemittanceList.NetRemitted > dailyCollectionRemittanceList.GrossCollection)
                        {
                            ...
                            collectionData.AddCell(new PdfPCell(new Phrase("Over " + diff.ToString("#,##0.00"), fontArial11)) { PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f });
                        }
                        else
                        {
                            if (dailyCollectionRemittanceList.NetRemitted < dailyCollectionRemittanceList.GrossCollection)
                    ...
                    collectionData.AddCell(new PdfPCell(new Phrase(" ", fontArial11)) { Colspan = 3, PaddingTop = 6f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f });

                    Decimal collectionBalance = totalGross - totalRelease;
