        ...
        public ActionResult Collectibles(String loanId)
        {
            if (loanId != null)
            {
                ...
                if (loan.Any())
                {
                    ...
                    var loanLines = from d in db.trnCollectionLines
                    ...
                    if (loanLines.Any())
                    {
                        ...
                        loanLineslData.AddCell(new PdfPCell(new Phrase("Pay Date", fontArial12Bold)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f, BackgroundColor = BaseColor.LIGHT_GRAY });
                        ...
                        loanLineslData.AddCell(new PdfPCell(new Phrase("Particulars", fontArial12Bold)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f, BackgroundColor = BaseColor.LIGHT_GRAY });

                        foreach (var loanLine in loanLines)
                        {
                            loanLineslData.AddCell(new PdfPCell(new Phrase(loanLine.PayDate.ToString("MM-dd-yyyy dddd"), fontArial11)) { PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanLineslData.AddCell(new PdfPCell(new Phrase(loanLine.sysCollectionStatus.Status, fontArial11)) { PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f });
                            ...
                            loanLineslData.AddCell(new PdfPCell(new Phrase(loanLine.Particulars, fontArial11)) { PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f });
                        }
