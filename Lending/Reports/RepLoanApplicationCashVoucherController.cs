...
{
    public class RepLoanApplicationCashVoucherController : Controller
    {
        // data
        ...
        [Authorize]
        public ActionResult loanApplicationCashVoucher(Int32? loanId)
        {
            if (loanId != null)
            {
                ...
                if(loanApplicationIsLocked.Any()) 
                {
                    if (loanApplicationIsLocked.FirstOrDefault().IsLocked)
                    {
                        ...
                        if (loanApplications.Any())
                        {
                            ...
                            loanApplicationData.AddCell(new PdfPCell(new Phrase(loanApplications.FirstOrDefault().Particulars, fontArial12)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingLeft = 5f, PaddingRight = 30f });
                            ...
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase(loanApplications.FirstOrDefault().ProcessingFeeAmountDeduction.ToString("#,##0.00"), fontArial12)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            ...
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase(loanApplications.FirstOrDefault().PassbookAmountDeduction.ToString("#,##0.00"), fontArial12)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12Bold)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            ...
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase(loanApplications.FirstOrDefault().PenaltyAmountDeduction.ToString("#,##0.00"), fontArial12)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12Bold)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            ...
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase(loanApplications.FirstOrDefault().LateIntAmountDeduction.ToString("#,##0.00"), fontArial12)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12Bold)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            ...
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase(loanApplications.FirstOrDefault().AdvanceAmountDeduction.ToString("#,##0.00"), fontArial12)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12Bold)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            ...
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase(loanApplications.FirstOrDefault().RequirementsAmountDeduction.ToString("#,##0.00"), fontArial12)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12Bold)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("Insurance IPI / PPI", fontArial12)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase(loanApplications.FirstOrDefault().InsuranceIPIorPPIAmountDeduction.ToString("#,##0.00"), fontArial12)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationDeductions.AddCell(new PdfPCell(new Phrase("", fontArial12Bold)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 5f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            ...
                            loanApplicationTotal.AddCell(new PdfPCell(new Phrase(loanApplications.FirstOrDefault().NetAmount.ToString("#,##0.00"), fontArial12)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 15f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                            loanApplicationTotal.AddCell(new PdfPCell(new Phrase("", fontArial12Bold)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 15f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
